...
const App = () => {
  ...
  return (
    <div
      className="min-h-screen w-full relative flex items-center justify-center overflow-hidden max-[426px]:p-2"
      style={{
        background:
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-3 min-h-[20vh] max-[426px]:h-[60vh]">
